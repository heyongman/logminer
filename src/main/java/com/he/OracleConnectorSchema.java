...
//    public static final Schema EMPTY_SCHEMA = SchemaBuilder.struct().optional().build();
    ...
    public static final String REGEX_LOB_WRITE = "^select (.*) into loc_\\w from (.*) where (.*) for update$";
    public static final String UPDATE_TEMPLATE = "update %s set %s = '%s' where %s";

    public static final String OPERATION_LOB_WRITE = "LOB_WRITE";
}
